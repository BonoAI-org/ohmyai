<script>
	...
	onMount(() => {
		...
		// Initialise le thème / Initialize theme
		themeStore.init();
...
<svelte:head>
	...
	<meta
		name="description"
		content="Chatbot IA 100% local fonctionnant dans votre navigateur via WebAssembly. Aucune donnée envoyée à un serveur."
	/>
	<meta
		name="keywords"
		content="AI, LLM, WebAssembly, Local AI, Privacy, Chat, Chatbot"
	/>
...
{#if $isLoading}
	<div
		class="h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center"
	>
		<div class="flex flex-col items-center gap-4">
			<div
				class="animate-spin rounded-full h-12 w-12 border-4 border-purple-500 border-t-transparent"
			></div>
			<p class="text-slate-900 dark:text-white text-lg">
				Loading / Chargement...
			</p>
		</div>
	</div>
