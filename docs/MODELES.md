...
- **Notes importantes / Important notes**:
  ...
  - Deux autres dépôts « ONNX » de cette variante existent (`justinchuby/gemma-4-26b-a4b-it-onnx`, `ReconOut/gemma-4-26B-A4B-it-oQ8e`) mais sont au format **onnxruntime-genai** ou en safetensors : Transformers.js ne peut pas les charger / Two other "ONNX" repositories of this variant exist (`justinchuby/gemma-4-26b-a4b-it-onnx`, `ReconOut/gemma-4-26B-A4B-it-oQ8e`) but are in the **onnxruntime-genai** format or in safetensors: Transformers.js cannot load them.
